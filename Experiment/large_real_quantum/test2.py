...
with open('29_ghz3.txt', 'r') as file:
    data = json.load(file)
...
for result in data["results"]:
    ...
    state_111_count = counts.get("0x1", 0)
    state_2_count = counts.get("0x2", 0)
    state_3_count = counts.get("0x3", 0)
    state_4_count = counts.get("0x4", 0)
    state_5_count = counts.get("0x5", 0)
    state_6_count = counts.get("0x6", 0)
    state_7_count = counts.get("0x7", 0)
