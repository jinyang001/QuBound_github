...
data = pd.read_csv('../../datasets/ibmq_mumbai/GHZ_12_ibmq_mumbai.csv')
data_real = pd.read_csv('../../datasets/real_30_mumbai_new_ghz12.csv')
...
X_data_real = X_data_real.reshape(X_data_real.shape[0], -1, 12, 5)
...
# # After training
# if best_model_state:
#     torch.save(best_model_state, 'best_model_state_GHZ12_test_all_two.pth')
...
#
model.load_state_dict(torch.load('best_model_state_GHZ12_test_all_two.pth'))
...
for x in x_values:
    ...
    states_to_plot = ['000000000000', '111111111111', '111000000000', '100000000000', '111111111011','111101111111',
                      '001111111111','000111111011','000011111111',
                      '100000000000']
    ...
    data_to_save = pd.DataFrame({
        ...
        'Predicted Lower Bound_0x0': predicted_lower_bound_selected_real[:, 0],
        'Predicted Upper Bound_0x0': predicted_upper_bound_selected_real[:, 0],
        'Predicted Lower Bound_0xfff': predicted_lower_bound_selected_real[:, 1],
        'Predicted Upper Bound_0xfff': predicted_upper_bound_selected_real[:, 1],
        'Predicted Lower Bound_0xe00': predicted_lower_bound_selected_real[:, 2],
        'Predicted Upper Bound_0xe00': predicted_upper_bound_selected_real[:, 2],
        'Predicted Lower Bound_0x200': predicted_lower_bound_selected_real[:, 3],
        'Predicted Upper Bound_0x200': predicted_upper_bound_selected_real[:, 3],
        'Predicted Lower Bound_0xffb': predicted_lower_bound_selected_real[:, 4],
        'Predicted Upper Bound_0xffb': predicted_upper_bound_selected_real[:, 4],
        'Predicted Lower Bound_0xf7f': predicted_lower_bound_selected_real[:, 5],
        'Predicted Upper Bound_0xf7f': predicted_upper_bound_selected_real[:, 5],
        'Predicted Lower Bound_0x3ff': predicted_lower_bound_selected_real[:, 6],
        'Predicted Upper Bound_0x3ff': predicted_upper_bound_selected_real[:, 6],
        'Predicted Lower Bound_0x1fb': predicted_lower_bound_selected_real[:, 7],
        'Predicted Upper Bound_0x1fb': predicted_upper_bound_selected_real[:, 7],
        'Predicted Lower Bound_0xff': predicted_lower_bound_selected_real[:, 8],
        'Predicted Upper Bound_0xff': predicted_upper_bound_selected_real[:, 8],
        'Predicted Lower Bound_0x800': predicted_lower_bound_selected_real[:, 9],
        'Predicted Upper Bound_0x800': predicted_upper_bound_selected_real[:, 9],


    })

    # Write the DataFrame to a CSV file
    data_to_save.to_csv('output_12_test_all.csv', index=False)
