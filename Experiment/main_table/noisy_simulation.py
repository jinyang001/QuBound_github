...
shots = 2000
total_runs = 400  # Fixed number of runs
...
for _ in range(total_runs):
    ...
    result = execute(qc, simulator, coupling_map=coupling_map,
                     basis_gates=basis_gates, initial_layout=[0,1,4,7,10,12,13,14,16], noise_model=noise_model,
                     shots=shots).result()
...
df.to_csv('noise_sim_bound_GHZ9.csv', index=False)
