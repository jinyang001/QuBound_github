...
for x in x_values:
    ...
    plt.plot(predicted_upper_Z, linestyle='--', label='Predicted Upper Bound', color='red')
    plt.plot(predicted_lower_Z, linestyle='--', label='Predicted Lower Bound', color='green')
    plt.plot(actual_Z, label='Test Actual', color='blue')
    ...
    average_non_zero_bdp_agnostic = sum(non_zero_bdp_agnostic) / len(
        non_zero_bdp_agnostic) if non_zero_bdp_agnostic else 0
    print("----------")
