...
data = pd.read_csv('../../datasets/ibm_nairobi/GHZ_3_ibm_nairobi.csv')
data_real = pd.read_csv('../../datasets/real_30.csv')
# Extract X_data for the given sample
X_data_real = data_real.iloc[:, :- (8 + 7)].values
y_data_real = data_real.iloc[:, -8:].values
...
for x in x_values:
    ...
    data_to_save.to_csv('output.csv', index=False)
