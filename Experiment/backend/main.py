...
# After training
if best_model_state:
    torch.save(best_model_state, 'best_model_state_GHZ3_nairobi.pth')
...
# model.load_state_dict(torch.load('best_model_state_GHZ3_kolkata.pth'))
model.eval()
